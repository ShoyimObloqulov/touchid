<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $password = strval(md5($response['password']));
        $sql = mysqli_query($link, "INSERT INTO `users` (`login`,`password`,`name`, `call`, `position`, `definition`)
                                            VALUES ('$login','$password','$name','$call','$position','$definition')");
